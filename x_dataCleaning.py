...
#now that we know what the outliers are we need to DECIDE what what the correct answer should be and address is manually. speak to the DATA set creator for more info on outlier.
